...
function renderServices(){
  ...
  SERVICES.forEach(s=>{
    ...
    let icon='✂';
    if(n.includes('barba') && !n.includes('corte')) icon='◒';
    else if(n.includes('sobrancelha')) icon='⌁';
    else if(n.includes('alisante') || n.includes('pintura')) icon='✦';
    else if(n.includes('closed')) icon='◆';
    else if(n.includes('cmt') || n==='cs') icon='•';
    el.innerHTML=`
